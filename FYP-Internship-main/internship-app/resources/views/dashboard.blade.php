        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if (Auth::user()->isStudent())
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-slate-200">
                    <div class="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            <p class="text-sm uppercase tracking-wider text-slate-400">Cover Letter Builder</p>
                            <p class="text-lg font-semibold text-slate-900">Draft a professional cover letter</p>
                            <p class="text-sm text-slate-500 mt-1">Write, preview, and download as PDF.</p>
                        </div>
                        <a href="{{ route('student.cover-letter.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:ring-2 focus:blue-emerald-500 focus:ring-offset-2">
